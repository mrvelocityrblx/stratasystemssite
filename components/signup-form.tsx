...
import { generateVerificationCode, sendVerificationEmail, verifyCode, clearVerificationCode } from "@/lib/email-service"
import {
  Dialog,
  DialogContent,
  DialogDescription,
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            <div className="bg-accent/10 border border-accent/20 rounded-lg p-4 text-center">
              ...
              <p className="text-3xl font-bold text-accent tracking-wider">{verificationCode}</p>
              <p className="text-xs text-muted-foreground mt-2">This code will expire in 10 minutes</p>
            </div>
